            ...
            <div className="achievement_details">
                <div className="achievement_intro">
                        ...
                        <div className="achievement_content">
                            Some of my achievements for which I worked hard and which helped me meet awesome 
                            people in my field.
                        </div>
                </div>
                <div className="achievement_cards">
                    ...
                    <AchievementCard heading="GHCI student scholarship recipient for 2019 "
                                    subheading="Won the GHCI scholarship to attend the 3 day event in Banglore in November 2019. ">
                    </AchievementCard>
                    <AchievementCard heading="Stood 3rd in my department in the 3rd year"
                    ...
                    <AchievementCard heading="Zonal Finalist of the KPMG Innovation and Collaboration Challenge 2019 "
                                    subheading="Represented our college in the zonal level of the Competition top solve problems related to eyesight issues in rural areas.   ">
                    </AchievementCard>
